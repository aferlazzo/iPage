...
<title>eBook Request Failure</title>
<base target="_self">
...
<div class="Title">
<div id="Big"><h1>Request Failure</h1></div>
<div id="BigShadow"><h1>Request Failure</h1></div></div>
</div><br style="clear:left;">
	<p>It's Okay. Simply use your <b><i>Back</i></b> menu bar choice to make a correction of the fields.</p>

	<p style="text-align: center;">
		<img border="0" alt="Mortgage Game eBook" src="../images/MortgageGameeBook.gif" width="176" height="220"></p>
	<hr>
