...
<!-- Atomz Search HTML for Lightning Mortgage -->
		...
		<td class="Top" align="center" height="12" valign="bottom" width="440">
            <a href="Feedback.php" class="Top">Help</a>
            &nbsp;|&nbsp; <a href="AboutUs.php" class="Top">About</a>
            &nbsp;|&nbsp; <a href="ContactUs.php" class="Top">Contact</a>
            &nbsp;|&nbsp; <a href="Calculators.php" class="Top">Calculators</a>
            &nbsp;|&nbsp; <a href="MyLoanStatus.php" class="Top">My Loan Status</a>
            &nbsp;|&nbsp; <a href="PrivacyPolicy.php" class="Top">Privacy</a>
            &nbsp;|&nbsp; <a href="Legal.php" class="Top">Legal</a>
		</td>
		...
		<td height="101" align="right" width="144" rowspan="2" valign="middle">
            ...
            <a href="UpfrontMortgageBroker.php"><img border="0"
...
<table width=720 border="0" cellpadding="0" cellspacing="0" height="28">
	...
	<tr>
	    	<!--<h2><a class=Index href="index2.php">Bad Credit Home Loans</a></h2>-->
		<td align="center" width="120" height="28" background="../images/Home_tab.gif">
		<a class="IndexMM" href="index.php">
		Home</a></td>

		<td align="center" width="120" height="28" background="../images/ApplyNow_tab.gif">
		<a class="ApplyMM" href="http://host373.ipowerweb.com/~lightnin/LoanAppShort.php">
		Apply Now</a></td>
...
height="79" alt="Lightning Mortgage Financing Guarantee"></a>
       ...
       <a href="index.php">Home</a>&nbsp;| 
		<a href="LoanAppShort.php">Apply Now</a>&nbsp;| 
		<a href="OrderCreditDirect.php">Order Credit</a>&nbsp;|
       <a href="LoanTypes.php">Loan Types</a>&nbsp;|
       <a href="InterestRates.php">Interest Rates</a>&nbsp;|
       <a href="Documentation.php">Documents</a>&nbsp;| 
  ...
  <tr>
   ...
   <td height="18" valign="top" align="center" width="620">
        ...
        <a href="RebateRequest.php">Instant Cash</a>&nbsp;|
        <a href="CreditScores.php">Credit Scores</a>&nbsp;|
        <a href="PrivacyPolicy.php">Privacy Policy</a>&nbsp;|
        <a href="Legal.php">Legal</a> | 
        <a href="AffiliateLinks.php">Affiliates</a></p>
  ...
  <tr>
   ...
   <center>
      ...
      <tr><td width="620" height="16">
        <p class="CenterSmall">Click on <a href="Feedback.php">feedback</a> or call (866) 822-8500 for assistance</p>
