...
<head>
<title>Send a Credit Request Action</title>
...
<!--ih:includeHTML file="../include/bottom.php"-->
		...
		<div class="Bottom2">
			<div style="float:right;height:90px;width:70px;">
				<img border='0' src='../images/equalhouse.gif' alt='Equal housing lender'>
			</div>
...
<!--/ih:includeHTML-->
<!--ih:includeHTML file="../include/top.php"--><!-- ./include/top-root.php is a copy of the contents ./include/top.php with the directory levels changed-->
<div class="Top">
	<div id='TipTop'>
		...
		<div id="MSborder">
		 <div id="Inside">
		 	  <a id='Inside' href="http://www.lightning-mortgage.com/Answers/MortgageInsiderSecrets.php" 
