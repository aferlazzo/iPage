...
<script language="javascript" src="../js/LoanAppValidationnew.js" type="text/javascript"></script>
...
<div class="Title"><h1 id="Small">Show Me<br />The Money!</h1></div>
<div class="Title">
...
-->
	...
	If so, click on <a href="OrderCreditDirect.php">Order a Credit Report</a>.</p>

	<p><img src='../images/IconRequired.gif' alt=''> denotes required fields</p>
	<p><img src="../images/lock.gif" alt="security lock"> This loan application is on a Secure Server for your
	<a href="../Administrative/PrivacyPolicy.php">
	privacy</a>.<br />&nbsp;</p>

	<form name="main" onsubmit="return(validate());"
	action="https://host373.ipowerweb.com/~lightnin/MortgageApplication/LoanAppShort.php"
	method="post">
...
<div class="RCLO">
	<p class="AppLabel"><label for="Employer">Borrower's Employer Name</label></p>
</div>
...
<div class="RCLO">
	<p class="AppLabel"><label for="B_2002Income">2005<br />Total Income</label></p>
</div>
...
<div class="LCLO">
	<p class="AppLabel"><label for="HomePhone">Home<br />Phone</label></p>
</div>
...
<div class="LCIO">
	<span class="AppField" style="height: 24px;"><select size="1" style="color:#009;" name="BestPhoneToCall" id="BestPhoneToCall" tabindex="11">
		<option value="Either Phone" selected>Either Phone
...
<div class="LCLE">
	<p class="AppLabel"><label for="EstCreditRating">Rate Your<br />Credit</label></p>
...
<div class="LCIE">
	...
	<option value="Good (B)" selected>Good</option>
...
<div class="RCLE">
	<p class="AppLabel"><label for="Co_2002Income">Co-Borrower's 2005 Total Income</label></p>
</div>
...
<div class="LCLO">
	<p class="AppLabel"><label for="MonthlyCreditCardDebt">Monthly Credit Card Payments</label></p>
</div>
...
<div class="RCLO">
	<p class="AppLabel"><label for="FinanceRequest">Finance<br />Request Type</label></p>
</div>
...
<div class="RCIO">
	...
	<option value="Construction-to-Perm">Construction-to-Perm</option>
...
<div class="LCIE">
	...
	onfocus="this.style.border='2px solid #099'" onblur="this.style.border='2px solid silver';document.main.EstimatedValue.value=this.value;"></p>
</div>



<div class="RCLE">
	<p class="AppLabel"><label for="LoanAmount">Loan Amount<br />
...
<div class="RCIO">
	<p class="AppField" style="height: 24px;">&nbsp;</p>
</div>
<br clear="all">
...
<div class="RCLE">
	<p class="AppLabel"><label for="HowReferred">How did you find us?</label></p>
</div>
...
onclick="this.value='One moment...'" onMouseover="this.className='MouseOver'" onMouseout="this.className='Submit'"
type="Submit" class="Submit" name="Submit" value="Submit Application" tabindex="64">
	<br />&nbsp;</p>
</div>
...
<script type="text/javascript">
initAnimateLeft('Lucio');

/* This code forces the page to be run from the secured server */

/*
if (window.location.href.substring(0,5)!="https")
{ alert('https://host373.ipowerweb.com/~lightnin/MortgageApplication/LoanAppShortnew.php'); window.location.replace('https://host373.ipowerweb.com/~lightnin/MortgageApplication/LoanAppShort-new.php'); }
else
alert("Secure Page");
*/
</script>
