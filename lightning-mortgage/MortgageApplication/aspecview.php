...
<HTML>
	<HEAD>
		...
		function FillForm()
		{
			document.all.Firstname.value="Bill";
			document.all.Lastname.value="Steiner";
			document.all.Suffix.value="";
			document.all.SSN.value="216965192";
			
			document.all.FirstnameCoborrower.value="Charles";
			document.all.LastnameCoborrower.value="Garrett";
			document.all.SuffixCoborrower.value="";
			document.all.SSNCoborrower.value="243434449";
			
			document.all.StreetAddress.value="563 68th B";
			document.all.City.value="Arverne";
			document.all.State.value="NY";
			document.all.Zip.value="11692";
			document.all.Suffix.value="";
			...
			document.all.billing_st.value = "1048 Sunflower Ave. Ste. 100";
			document.all.billing_city.value = "Costa Mesa";
			document.all.billing_state.value = "CA";
			document.all.billing_zip.value = "92626";
			document.all.billing_month.value = "12";
			document.all.billing_year.value = "2005";
			//document.all.billing_cvv.value = "987";
			//document.frm.msgbox.style.visibility = "hidden";
			
			document.all.PhoneNumber.value = "800.555.1212";
			document.all.EmailAddress.value = "MyEmail@yahoo.com";
	...
	<LINK rel="stylesheet" type="text/css" href="aspec.css">
		<body>
			<form id="frm" method="post" action="view.php">
