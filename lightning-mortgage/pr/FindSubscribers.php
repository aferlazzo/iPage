...
//if ($Returned == "true")
//  die("EditSubscriber.php returning values<br/>User Name |$UserName|<br />Email |$Email|<br/>vtype |$vtype|<br/>arid |$ID|<br/>MM |$MM|<br/>DD |$DD|<br/>YY |$YY|<br/>hh |$hh|<br/>mm |$mm|<br/>MessageNumber |$MessageNumber|<br/>uid |$uid|");		
...
print("  if((isIntegerInRange(document.EditSubscriberForm.MM,1,12)==false) \n");
print("  || (isIntegerInRange(document.EditSubscriberForm.DD,1,31)==false) \n");
print("  || (isIntegerInRange(document.EditSubscriberForm.YY,0,99)==false) \n");
print("  || (isIntegerInRange(document.EditSubscriberForm.hh,0,23)==false) \n");
print("  || (isIntegerInRange(document.EditSubscriberForm.mm,0,59)==false)\n");
print("  || (isIntegerInRange(document.EditSubscriberForm.MessageNumber,0,255)==false))\n");
print("	{\n");
print("	   document.EditSubscriberForm.Submit2.value='Change';\n");
print("		 document.EditSubscriberForm.Submit2.className='submit';\n");
print("		 document.EditSubscriberForm.Submit2.blur();\n");
print("		 return false;\n");
print("	}\n");

print(" if(SearchType == 'email')\n{\n");
print("var Email =  allTrim(document.EditSubscriberForm.Email.value);\n");
print("document.EditSubscriberForm.Email.value = Email;\n");

print(" if(isEmpty(Email)) \n");
print("	{\n");
print("	   alert('Email address must be filled.');\n");
print("	   document.EditSubscriberForm.Submit2.value='Find';\n");
print("		 document.EditSubscriberForm.Submit2.className='submit';\n");
print("		 document.EditSubscriberForm.Submit2.blur();\n");
print("		 return false;\n");
print("}}\n");
...
print("var UserName =  allTrim(document.EditSubscriberForm.UserName.value);\n");
print("document.EditSubscriberForm.UserName.value = UserName;\n");
...
<div id="navBeta">
	...
	<p>If you are unsure of a last name, for example, you can type in the first few characters of a name. You canuse a % symbol as a wildcard symbol.  A list of matching names 
	will be returned.</p>
	<p>Want to delete a subscription record? Check the 'Del' box of the associated row. Be careful, though. This is a true record delete.
	The delete functions in the Campaign Manager and in the Unsubscribe pages merely set the Message Number. See the following charty:</p>
...
<?php
	...
	print("<form name='EditSubscriberForm' method='post' onSubmit='return(Validate(document.EditSubscriberForm.vtype.value));' action='FindSubscribersAction.php' target='Monitor'>\n");
