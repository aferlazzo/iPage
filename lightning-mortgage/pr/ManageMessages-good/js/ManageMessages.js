...
//AJAX: Next, this function makes the XMLHttpRequest request

function ajaxAll(mmm)
{
  var url = "./ManageMessagesAction.php?cmd=" + mmm;
...
// AJAX: Finally, the callback function set in xmlHttp.onreadystatechange will be called when data is back from the server
...
{ 
	...
	// must be rewritten in the database every time a sort ends just in case, for example,
	// the first message is dragged behind the last message.
	location.href=messageOrder;
}
