...
?>
<html>
<Head><Title>RestartCampaignAction</Title>
...
if ($Count == 1)
{
	print("<p style='font-family:verdana;font-size:small;'>matching user: $row->fname &lt;$row->email&gt;</p>\n"); 
}

	$Send_To = mktime(1,0,0,date("m"),date("d"),date("Y")); //start date is today at 1 AM
	$dd = 
	printf("<p style='font-family:verdana;font-size:small;'>arid %s restart campaign date/time: %s</p>",$arid, date('m\/d\/Y H:i:s'));
...
?>
<h2>Restarting <?php echo $Count ?> subscribers</h2>
<p>The subscribers you selected will begin receiving messages, 
starting from the Welcome message.</p>
</div></div>
</Body>
</Html> 
