 ...
 */
define('SWIFT_SMOKE_EMAIL_ADDRESS', 'prontocommercial@gmail.com');
...
/*
 ...
 Recommended: (none)
 */
define('SWIFT_SMOKE_SMTP_USER', 'prontocommercial@gmail.com');

/*
 Defines: A password to authenticate with SMTP (if needed).
 Recommended: (none)
 */
define('SWIFT_SMOKE_SMTP_PASS', '1commguru');
