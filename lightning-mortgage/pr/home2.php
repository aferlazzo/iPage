...
<style type="text/css">
#content p, #content ol li {margin:20px;text-align:left;}
</style>
</HEAD>
<body>
...
-->
<p>There are 3 steps to quickly making this system work for you:</p>
<ol><li>Create the campaign. This sets up the name and email address from which messages with be sent.</li>
<li>Create messages and their schedule for delivery.</li>
<li>Add subscribers and/or possibly modify web pages to include opt-in code.</li></ol>
</div></div>
</BODY>
</HTML>