...
// for a description of the format, see http://www.unixgeeks.org/security/newbie/unix/cron-1.phpl
...
if ($debugIt > 0)
	logMessage ("pseudo-cron.inc (".__LINE__.") Starting... Somebody is visiting www.lightning-mortgage.com");
